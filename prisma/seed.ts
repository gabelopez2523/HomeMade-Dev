  ...
  await prisma.foodListing.createMany({
    data: [
      // Maria's listings
      {
        ...
        price: 18.00,
        imageUrls: ['https://images.unsplash.com/photo-1534352956036-cd81e27dd615?w=800'],
      ...
      },
      {
        ...
        price: 14.00,
        imageUrls: ['https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=800'],
        listingDate: tomorrow,
        pickupTime: pickupTomorrow,
        pickupLocation: 'Near the Railyard, Santa Fe',
        city: 'Santa Fe',
      ...
      },
      {
        ...
        price: 6.00,
        imageUrls: ['https://images.unsplash.com/photo-1558303289-166b1fa13987?w=800'],
      ...
      // James's listings
      {
        ...
        price: 22.00,
        imageUrls: ['https://images.unsplash.com/photo-1529193591184-b1d58069ecdd?w=800'],
        listingDate: weekend,
      ...
      },
      {
        ...
        price: 16.00,
        imageUrls: ['https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=800'],
        listingDate: tomorrow,
        pickupTime: pickupTomorrow,
        pickupLocation: 'Southside Santa Fe, near Cerrillos Rd',
        city: 'Santa Fe',
      ...
      // Priya's listings
      {
        ...
        price: 15.00,
        imageUrls: ['https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=800'],
        listingDate: tomorrow,
        pickupTime: pickupTomorrow,
      ...
      },
      {
        ...
        price: 10.00,
        imageUrls: ['https://images.unsplash.com/photo-1601050690597-df0568f70950?w=800'],
        listingDate: dayAfter,
        pickupTime: pickupDayAfter,
        pickupLocation: 'Downtown Santa Fe, near the Plaza',
        city: 'Santa Fe',
      ...
      },
      {
        ...
        price: 5.00,
        imageUrls: ['https://images.unsplash.com/photo-1527661591475-527312dd65f5?w=800'],
        listingDate: tomorrow,
        pickupTime: pickupTomorrow,
        pickupLocation: 'Downtown Santa Fe, near the Plaza',
        city: 'Santa Fe',
      ...
      // Rosa's listings
      {
        ...
        price: 24.00,
        imageUrls: ['https://images.unsplash.com/photo-1530469525856-cf37954301f7?w=800'],
        listingDate: weekend,
        pickupTime: pickupWeekend,
      ...
      },
      {
        ...
        price: 22.00,
        imageUrls: ['https://images.unsplash.com/photo-1586511925558-a4c6376fe65f?w=800'],
        listingDate: weekend,
        pickupTime: pickupWeekend,
        pickupLocation: 'Santa Fe Place Mall area',
        city: 'Santa Fe',
      ...
      },
      {
        ...
        price: 12.00,
        imageUrls: ['https://images.unsplash.com/photo-1612549584500-c2a5da73ca3d?w=800'],
        listingDate: weekend,
        pickupTime: pickupWeekend,
        pickupLocation: 'Santa Fe Place Mall area',
        city: 'Santa Fe',
